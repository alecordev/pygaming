...
class Offensive(unit.Unit):
    def __init__(self, coord, team):
        ...
        self.imagesnotselected = (
            load_image(PATHS["sprites"] + team + "attack.png"),
            load_image(PATHS["sprites"] + team + "attack_1.png"),
        )
        self.imageselected = (
            load_image(PATHS["sprites"] + team + "attack_selected.png"),
            load_image(PATHS["sprites"] + team + "attack_selected_1.png"),
        )
        self.animation2 = (
            load_image(PATHS["sprites"] + team + "attack_75.png"),
            load_image(PATHS["sprites"] + team + "attack_50.png"),
            load_image(PATHS["sprites"] + team + "attack_25.png"),
        )
