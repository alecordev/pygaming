...
class Square(unit.Unit):
    def __init__(self, coord, team):
        ...
        self.imagesnotselected = (
            load_image(PATHS["sprites"] + team + "square.png"),
            load_image(PATHS["sprites"] + team + "square_1.png"),
        )
        self.imageselected = (
            load_image(PATHS["sprites"] + team + "selected_square.png"),
            load_image(PATHS["sprites"] + team + "selected_square_1.png"),
        )
        self.animation2 = (
            load_image(PATHS["sprites"] + team + "square_75.png"),
            load_image(PATHS["sprites"] + team + "square_50.png"),
            load_image(PATHS["sprites"] + team + "square_25.png"),
        )
    ...
    def attackunit(self):
        ...
        if self.target.name == "Offensive":
            self.target.life -= self.attack + 10 - self.target.armor
        else:
