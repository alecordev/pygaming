...
class Particle:
    ...
    def attract(self, other):
        ...
        dist = 1 if not math.hypot(dx, dy) else math.hypot(dx, dy)
        ...
        if dist < self.radius + other.radius:
            ...
            (self.angle, self.speed) = combineVectors(
                self.angle, self.speed, other.angle, other.speed
            )
            ...
            (self.angle, self.speed) = combineVectors(
                self.angle, self.speed, theta + math.pi, force / self.mass
            )
            (other.angle, other.speed) = combineVectors(
                other.angle, other.speed, theta, force / other.mass
            )
