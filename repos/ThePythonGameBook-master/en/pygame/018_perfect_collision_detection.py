        ...
        def update(self, time):
            ...
            if self.cooldown > 0:
                ...
                if pressedkeys[pygame.K_SPACE]:  # shoot forward
                    ...
                    self.shots += 1
                    Bullet(
                        self, -math.sin(self.angle * GRAD), -math.cos(self.angle * GRAD)
                    )
        ...
        for bird in birdgroup:
            ...
            if collision == "rect":
                crashgroup = pygame.sprite.spritecollide(
                    bird, bulletgroup, False, pygame.sprite.collide_rect
                )
            elif collision == "circle":
                crashgroup = pygame.sprite.spritecollide(
                    bird, bulletgroup, False, pygame.sprite.collide_circle
                )
            elif collision == "mask":
                crashgroup = pygame.sprite.spritecollide(
                    bird, bulletgroup, False, pygame.sprite.collide_mask
                )
            else:
