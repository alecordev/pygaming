...
)  # if you use tranparent colors you need convert_alpha()
ballrect = (
    ballsurface.get_rect()
)  # the rectangle of the ball surface, for collision detection
