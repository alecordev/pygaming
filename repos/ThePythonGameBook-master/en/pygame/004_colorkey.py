...
)  # faster blitting, convert_alpha() because transparency
screen.blit(background, (0, 0))  # draw background on screen (overwriting all)
ballx = 20  # left ball position
bally = 240
screen.blit(
    ballsurface, (ballx, bally)
)  # draw the ball surface (lines will draw over this ball)
...
while mainloop:
    ...
    # ------- draw cute pattern ------------------
    pygame.draw.line(
        screen, (color1, 255 - color1, color2), (32 * t, 0), (0, 480 - 24 * t)
    )
    pygame.draw.line(
        screen, (255 - color2, color2, color1), (32 * t, 480), (640, 480 - 24 * t)
    )
    ...
    pygame.display.set_caption(
        "Frame rate %.2f frames per second. Playtime: %.2f seconds"
