...
def makemenu(pos=0):
    ...
    Config.menu = ezmenu.EzMenu(
        ...
        [
            "Change screen resolution: %i x %i"
        ...
        [
            "visit ThePythonGameBook homepage",
            lambda: gameUrl("http://ThePythonGameBook.com"),
        ],
        ["Quit Game", gameQuit],
    )
...
def gameRun():
    ...
    playtime = screensaver.screensaver(
        Config.resolution, Config.fullscreen, False
    )  # the False avoid the screensaver to do pygame.quit()
...
def main():
    ...
    while Config.menuloop:
        ...
        # mouse to open url's
        if (
            pygame.mouse.get_pressed()[0] == True and cooldown == 0
            ...
            if mousey > 95 and mousey < 116:  # open game homepage
                ...
                webbrowser.open_new_tab(
                    "http://flattr.com/thing/163126/schwarzweiss-game"
                )
