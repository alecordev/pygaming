...
def gamemenu():
    gamefolder = os.path.expanduser(
        os.path.join("~", ".screensavertest")
    ...
    playername = easygui.enterbox(
        "What is you name?",
        "please enter you name and press ENTER or click ok",
        "Mister dunno",
    )
    while True:  # endless loop
        ...
        if selection == "quit":
            ...
            try:
                ...
                exit()
            easygui.textbox(
                "This is the Screensaver logfile", "displaying highscore", text
            )
            ...
            answer = easygui.choicebox(
                "Please select one of those screen resolutions", "x,y", reslist
            )
