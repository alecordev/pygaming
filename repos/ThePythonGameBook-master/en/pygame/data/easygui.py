...
# -----------------------------------------------------------------------
def ccbox(
    msg="Shall I continue?", title=" ", choices=("Continue", "Cancel"), image=None
):
    """
...
# -------------------------------------------------------------------
def buttonbox(
    msg="", title=" ", choices=("Button1", "Button2", "Button3"), image=None, root=None
):
    """
...
def integerbox(
    ...
    **invalidKeywordArguments
    ...
    if msg == "":
        msg = "Enter an integer between " + str(lowerbound) + " and " + str(upperbound)
...
# -----------------------------------------------------------------------
def multpasswordbox(
    msg="Fill in values for the fields.", title=" ", fields=tuple(), values=tuple()
):
    r"""
...
# __multfillablebox
# -----------------------------------------------------------------------
def __multfillablebox(
    msg="Fill in values for the fields.", title=" ", fields=(), values=(), mask=None
):
...
# -------------------------------------------------------------------
def enterbox(
    msg="Enter something.", title=" ", default="", strip=True, image=None, root=None
):
    """
...
# -------------------------------------------------------------------
def multchoicebox(
    msg="Pick as many items as you like.", title=" ", choices=(), **kwargs
):
    """
    ...
    try:
        ...
        if type(text) == type("abc"):
            ...
            try:
                ...
                msgbox(
                    "Exception when trying to convert "
                    + str(type(text))
                    + " to text in textArea"
                )
                sys.exit(16)
...
def egdemo():
    ...
    while 1:  # do forever
        ...
        choice = choicebox(
            msg=intro_message, title="EasyGui " + egversion, choices=choices
        )
        ...
        if reply[0] == "msgbox":
            ...
            longchoice = (
                "This is an example of a very long option which you may or may not wish to choose."
                * 2
            )
            listChoices = [
                "nnn",
