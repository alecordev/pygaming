...
def load_game_resources():
    ...
    pal = [
        (min(r + 100, 255), min(g + 100, 255), min(b + 100, 255)) for r, g, b in origpal
    ]
...
class Box:
    ...
    def tick(self, speedadjust):
        self.rotate += self.rotspeed * speedadjust * 0.2
        if self.firsttouch > 0.0:
            ...
            if self.popped >= 1.9:
                ...
                self.popped = min(self.popped + speedadjust * 0.35, 1.9)
