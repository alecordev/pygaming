...
class HealthView(evtman.SingleListener):
    ...
    def render(self, unused):
        ...
        for heart_id in range(1, self.health + 1):
            # Five hearts by row.
    ...
    def onHealthEvent(self, x=None, event=None):
...
class CarrotCounterView(evtman.SingleListener):
    ...
    def render(self, unused):
        ...
        text = font.render(u"\u00d7 %i" % self._carrots, False, (255, 255, 255))
        image.blit(text, (32, pos_y))

    def onCarrotEvent(self, x=None, event=None):
...
class StatusTextView(evtman.SingleListener):
    ...
    def onStatusTextEvent(self, x=None, event=None):
...
class StatsView(evtman.SingleListener):
    ...
    def render(self, unused):
        ...
        image.fill((32, 32, 32))
        pics = (
            pygame_.ASSETS_PICS["sprite_fox.png"],
            pygame_.ASSETS_PICS["sprite_blood.png"],
        )
        numbers = (self._living_foxes, self._dead_foxes)
    ...
    def onCreatureDiedEvent(self, x=None, event=None):
...
class CreatureView(MyEntityView):
    ...
    def onAttackEvent(self, x=None, event=None):
...
class BunnyView(CreatureView):
    ...
    def onShockWaveEvent(self, x=None, event=None):
...
class ShockWaveView(pygame_.EntityView):
    ...
    def render(self):
        ...
        pygame.draw.circle(
            image, (220, 220, 255, alpha), self._center, int(self._radius)
        )
...
class GameOverScreenView(evtman.SingleListener):
    ...
    def __init__(self, event_manager, time):
        ...
        self.sprite.image = pygame.Surface(
            pygame.display.get_surface().get_rect().size, pygame.SRCALPHA
        )
        self.sprite.rect = self.sprite.image.get_rect()
