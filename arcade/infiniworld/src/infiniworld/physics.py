...
class Collision(object):
    ...
    def correctVelocity(self):
        ...
        vder, vdee = elasticCollisionVelocities(
            self.collider, self.collidee, self.penetration.normalized()
        )
...
class CircularBody(Body):
    ...
    def collidesCircle(self, collider):
        ...
        try:
            penetration = (collider.pos - self.pos).normalized() * (radii - distance)
...
def elasticCollisionVelocities(part1, part2, normal):
    ...
    u1n, u2n = elasticCollisionSpeed(part1.mass, v1n, part2.mass, v2n)
