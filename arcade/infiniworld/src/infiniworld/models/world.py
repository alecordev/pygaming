...
class WorldModel(SingleListener):
    ...
    def onMoveEntityToNextAreaRequest(self, x=None, event=None):
    ...
    def onEntitySummaryRequest(self, x=None, event=None):
