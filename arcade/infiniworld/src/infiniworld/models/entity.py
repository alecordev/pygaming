...
class EntityModel(SingleListener):
    ...
    def __init__(self, event_manager, entity_id):
        ...
        self.exists = True
        # Physics.
        self.body = physics.CircularBody(
            self.BODY_MASS,
            geometry.Vector(),
            self.SOLID,
    ...
    area_id = property(_getAreaId, None, None, "Id of the area containing this entity.")
    ...
    def onMoveEntityRequest(self, x=None, event=None):
