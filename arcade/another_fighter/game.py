...
class Star(pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        pygame.draw.circle(self.image, (128, 128, 200), (0, 0), 2, 0)
        self.rect = self.image.get_rect()
        self.rect.center = (x, y)
        self.velocity = 1
        self.size = 1
    ...
    def accelerate(self):
        ...
        pygame.draw.line(
            self.image, (self.colour, self.colour, self.colour), (0, 0), (0, self.size)
        )
...
class StatusSprite(pygame.sprite.Sprite):
    ...
    def update(self):
        score = self.font.render(
            "Health : {} Score : {}".format(self.ship.health, self.ship.score),
            True,
            (150, 50, 50),
        )
