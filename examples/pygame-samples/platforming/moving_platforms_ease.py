"""
This program is almost identical to moving_platforms.py, but demonstrates a
different Control.update_viewport() method that allows us to ease in to
scrolling.

Here scrolling begins when the player crosses 1/3rd of the screen.
Scrolling begins at half the speed of the player, but once the player reaches
the halfway point scrolling matches the player's own speed.
...
class Control(object):
    ...
    def make_obstacles(self):
        ...
        walls = [
            Block(pg.Color("chocolate"), (0, 980, 1000, 20)),
        ...
        moving = [
            ...
            MovingBlock(
                pg.Color("olivedrab"), (420, 430, 100, 20), 550, 1, speed=3, delay=200
            ),
            MovingBlock(pg.Color("olivedrab"), (450, 700, 50, 20), 930, 1, start=930),
            MovingBlock(pg.Color("olivedrab"), (500, 700, 50, 20), 730, 0, start=730),
            MovingBlock(pg.Color("olivedrab"), (780, 700, 50, 20), 895, 0, speed=-1),
        ]
