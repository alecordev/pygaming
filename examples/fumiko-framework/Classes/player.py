    ...
    def get_players(self):
        for dirname, dirnames, filenames in os.walk(self.folder):
            for subdirname in dirnames:
                self.players[subdirname] = Player(
...
class Player:
    ...
    def slice_charset(self):
        ...
        number_of_horizontal_slices = int(charset_rect.width / width)
        number_of_vertical_slices = int(charset_rect.height / height)
