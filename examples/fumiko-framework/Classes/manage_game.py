...
class ManagesSettings:
    def __init__(self):
        self.settings = {
            "debug": {"on": True},
            "performance": {"frames_per_second": 60},
            "screen": {
                "windowed": True,
                "screen_size": {"x": 800, "y": 600},
                "scale": 2,
            },
            "levels": {"default_tile_width": 32, "default_height": None},
        }

        self.settings["levels"]["default_height"] = (
            self.settings["screen"]["screen_size"]["x"] / 1.5
        )
...
class ManagesPygame:
    def __init__(self):
        ...
        self._display = pygame.display.set_mode(
            (
                self.settings.get("screen")["screen_size"]["x"],
