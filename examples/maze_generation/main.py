...
class Node(pygame.sprite.Sprite):
    def __init__(self, game, pos, num, color):
        ...
        self.point_list = {
            "north": [self.rect.topleft, self.rect.topright],  # N
            "east": [self.rect.topright, self.rect.bottomright],  # E
            "south": [self.rect.bottomright, self.rect.bottomleft],  # S
            "west": [self.rect.bottomleft, self.rect.topleft],
        }  # W

        self.neighbors = {}
        self.walls = {"north": False, "east": False, "south": False, "west": False}
...
class Maze:
    def __init__(self):
        ...
        self.directions = (
            "Press space to generate maze, press space again to generate new maze!"
        )
