...
# Version : 0.0.2
# Modification history : Level2-add the sprite image + border collision
############################################################################
...
def main():
    while True:
        ...
        if dead == 1:
            ...
            screen.blit(
                s1.render("Press s To Play Again", True, (0, 255, 0)), (50, 250)
            )
            screen.blit(
                s2.render("Press l For Level Selection ", True, (0, 255, 0)), (50, 300)
            )
