...
class Example:
    def __init__(self):
        ...
        self.attrs = {"shape": "circle", "size": 6, "density": 6, "speed": 6}
            ...
            if event.type == QUIT:
                ...
                if event.key == 32:
                    if self.hide:
                        ...
                        self.hide = True
            if (event.type == MOUSEBUTTONDOWN and not self.constant) or (
                event.type == MOUSEMOTION and self.constant
            ):
